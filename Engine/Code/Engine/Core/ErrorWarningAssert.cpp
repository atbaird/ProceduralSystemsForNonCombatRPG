...
void RecoverableWarningNoPopUp(const char* filePath, const char* functionName, const int& lineNum, const std::string& reasonForWarning, const char* conditionText)
{
	std::string errorMessage = reasonForWarning;
	if (reasonForWarning.empty())
	{
